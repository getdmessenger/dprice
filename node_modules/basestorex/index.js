...
class InnerBasestore extends Nanoresource {
  constructor (storage, opts = {}) {
    ...
    // As discussed in https://github.com/dwebprotocol/basestore/issues/20
  ...
  get (baseOpts = {}) {
    if (!this.opened) throw new Error('Basestore.ready must be called before get.')
...
class Basestore extends Nanoresource {
  constructor (storage, opts = {}) {
    super()
  ...
  namespace (name) {
    ...
    return new Basestore(this.storage, {
      inner: this.inner,
      parent: this,
      name
    })
